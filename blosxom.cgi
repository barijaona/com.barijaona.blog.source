...
# blosxomsk mods : * added a $basedir variable
...
# for blosxom starter kit users :
# most of the settings are done in the flavours/pageprefs file
# Here, you will only need to change the $ENV{BLOSXOM_CONFIG_DIR} variable,
# and if you are using static rendering, set the $static_password
$ENV{BLOSXOM_CONFIG_DIR}="/Users/barijaon/blosxom" unless defined $ENV{BLOSXOM_CONFIG_DIR};
...
$datadir = "$ENV{BLOSXOM_CONFIG_DIR}/posts";
...
$plugin_list = "$ENV{BLOSXOM_CONFIG_DIR}/plugin_list.conf";
